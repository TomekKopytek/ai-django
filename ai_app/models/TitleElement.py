...
openai.api_key = os.environ.get('sk-proj-qxRwDrBL0b6OirS3xMJaT3BlbkFJzAE4RAlcJoYjNVqKHr73')  # Pobiera wartość zmiennej środowiskowej 'OPENAI_API_KEY' i przypisuje ją jako klucz API do klienta OpenAI
